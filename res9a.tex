...
\section{TECHNICAL \\ SKILLS}
		{\sl Languages \& Technologies:} Python, Java, Objective-C, PHP, HTML, CSS, JavaScript, JQuery,
		JSON, XML, REST, AJAX, MySQL, PostgreSQL, SQLite, Git \\
		{\sl Software:} Eclipse, Netbeans, Xcode, PyCharm \\
                	{\sl Operating Systems:} Unix (Mac OS), Windows, Linux, iOS, Android
